/******/ (() => {
  ...
  // IAB class imports and definitions
const { TCModel, TCString, GVL, Segment, Cloneable } = require("./iab-tcf-core");
const { CmpApi } = require("@iabtcf/cmpapi");

// IAB initialization logic
